...
const Home: React.FC = () => {
  return (
    <div className="flex items-start w-280">
      ...
      <Link to="id/my" className="grow">
        <img src={metrics} className="w-full" />
      </Link>
      <Link to="id/private-repository" className="grow">
        <img src={metricsPrivateRepository} className="w-full" />
      </Link>
